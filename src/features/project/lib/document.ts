import { migrateBoardImages } from "@/features/board/lib/boardImageRegistry";
import { ensureHtmlContent } from "@/features/editor/lib/editorContent";
import type { BoardItem, GddDocument, GddSection, GddSectionFolder } from "@/shared/types";
